...
//Simple but bad solution! - we expose how we get the data with a
//detailed informations about the 'Observable<Responce>' (the structure of
//of the JSON-file). We don't expose any types and the error handling, caching etc.
// is up to the client.
